...
function OutdoorPage() {
  ...
  const handleSendEmail = () => {
    const mailtoLink = `mailto:vnick8@hotmail.com?subject=Indoor Renovation&body=Name: ${formData.name}%0D%0A%0D%0APhone Number: ${formData.phoneNumber}%0D%0A%0D%0AAddress: ${formData.address}%0D%0A%0D%0ADescription: ${formData.description}`;
